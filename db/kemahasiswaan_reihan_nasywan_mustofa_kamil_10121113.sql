...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3445114531ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113&table=simulasi_nilai_akhir">`kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113`.`simulasi_nilai_akhir`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113&table=mahasiswa_nilai">`kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113`.`mahasiswa_nilai`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113&table=mahasiswa">`kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113`.`mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113&table=mata_kuliah">`kemahasiswaan_reihan_nasywan_mustofa_kamil_10121113`.`mata_kuliah`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=akdmk&table=t_nilai">`akdmk`.`t_nilai`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=akdmk&table=t_mahasiswa">`akdmk`.`t_mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=akdmk&table=t_mata_kuliah">`akdmk`.`t_mata_kuliah`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=if3&table=barang">`if3`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=if3&table=BARANG">`if3`.`BARANG`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_pw&table=siswa">`db_pw`.`siswa`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7d494176524e5650526825684a5e5b68">
