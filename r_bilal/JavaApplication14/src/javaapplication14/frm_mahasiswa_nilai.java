    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        if ((txt_nim.getText().isEmpty()) || (txt_kode_mk.getText().isEmpty())){
            ...
            try{
                ...
                Connection kon = DriverManager.getConnection(database,user,pass);
                Statement stt = kon.createStatement();
                String SQL = "INSERT INTO mahasiswa_nilai(nim,nama,no_mk,nama_mk,kehadiran,tugas_1,tugas_2,tugas_3,uts,uas,angkatan,nilai_absen,nilai_tugas,nilai_uts,nilai_uas,nilai_akhir,indeks,keterangan) VALUES "
                            + "( '"+txt_nim.getText()+"',"
